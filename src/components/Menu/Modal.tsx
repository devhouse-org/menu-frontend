  ...
  return (
    <div
      style={{
        ...
        backgroundColor: open ? "rgba(0, 0, 0, 0.30)" : "transparent",
      }}
    ...
    >
      <div
        ...
        className={`rounded-lg shadow-lg p-10 transition-all max-w-md  ${
      ...
      >
        <button
          ...
          className="absolute top-2 right-2 py-1 px-2 text-xl font-semibold rounded-md hover:bg-gray-50 hover:text-gray-600"
          onClick={onClose}
        >
          X
        </button>
