		...
		foods: [
			{
				...
				description:
					"Fried cheese sticks served with marinara sauce.",
				price: 8.99,
				image: Dish1,
			},
			{
	...
	},
	{
		...
		foods: [
			...
			},
			{
				name: "Greek Salad",
				description:
					"Mixed greens, tomatoes, cucumbers, olives, feta cheese, and Greek dressing.",
				price: 11.99,
				image: Dish2,
			},
			{
				name: "Cobb Salad",
				description:
					"Mixed greens, grilled chicken, avocado, bacon, eggs, and blue cheese dressing.",
				price: 12.99,
				image: Dish3,
			},
			{
		...
		foods: [
			{
				name: "Grilled Salmon",
				description:
					"Fresh grilled salmon fillet served with seasonal vegetables and rice.",
				price: 18.99,
				image: Dish1,
			},
			{
				name: "Filet Mignon",
				description:
					"8 oz. USDA Prime beef tenderloin served with mashed potatoes and asparagus.",
				price: 24.99,
				image: Dish2,
			},
			{
				...
				description:
					"Spaghetti tossed with mixed vegetables in a light tomato sauce.",
				price: 14.99,
				image: Dish3,
			},
			{
		...
		foods: [
			{
				...
				description:
					"Creamy cheesecake served with raspberry sauce.",
				price: 7.99,
				image: Dish1,
			},
			{
