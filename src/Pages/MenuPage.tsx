...
const MenuPage = () => {
  ...
  return (
    <div
      className="relative min-h-screen min-w-screen flex font-montserrat overflow-auto"
      style={{
        color: theme.primary,
              ...
              {data.categories.map((item: any, index: number) => {
                return (
                  <li
                    ...
                    style={{
                      backgroundColor:
                        index === cat ? theme.secondary : "transparent",
                      color: index === cat ? "white" : theme.primary,
                    }}
